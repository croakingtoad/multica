...
// Source evidence for the fork's projects-and-resources skill (LOCO-896):
// the skill payload ships user-observable behavior only (see the banned
// patterns below), so the source-backed map that used to ride along in
// references/projects-and-resources-source-map.md lives here beside the
