...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"hook_fire_history":                  workspaceDelete,
	"hook_state_snapshot":                workspaceDelete,
	...
	"project_plan":                       workspaceDelete,
	"project_plan_dependency":            workspaceDelete,
	"project_plan_kind":                  workspaceDeleteKeep,
	"project_plan_part":                  workspaceDelete,
	"project_plan_part_issue":            workspaceDelete,
	"project_plan_phase":                 workspaceDelete,
