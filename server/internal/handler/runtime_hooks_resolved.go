...
// hookResolution adapts stored snapshot rows to the resolution layer's
// projection. The provider rules stay in server/internal/runtimehooks; this
// file only moves rows across the seam, so the projection can be tested
// without a database.
